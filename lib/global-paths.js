...
function setHash(name, extension, data) {
  ...
  console.log('setHash() hashes: ', hashes);
...
function getUnusedCssSelectors() {
  console.log('getting unused css selectors');
  return readUserFile(fileNames.unusedCssSelectors);
}

function getUserInlineJs(Assets) {
  console.log('get user inline js');
  return readUserFile(fileNames.userInlineJs, Assets);
}

function saveStrippedStylesheet(data) {
  console.log('save stripped stylesheets');
...
module.exports.saveStrippedStylesheet = saveStrippedStylesheet;
